...
const LoginScreen = () => {
  ...
  return (
    <LinearGradient colors={['#1E2749', '#283C63']} style={styles.container}>
      ...
      <TouchableOpacity style={styles.link} onPress={() => console.log('Ir a la pantalla de recuperación de contraseña')}>
        <Text style={styles.linkText}>¿Olvidaste tu contraseña?</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.link} onPress={() => console.log('Ir a la pantalla de registro')}>
